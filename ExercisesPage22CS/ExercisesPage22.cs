...
namespace ExercisesPage22CS
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //EXERCISE 3 Page 22
            Console.WriteLine("Are you eligible to view the content of our website? Please type your age to determine if this is true:");
            int userAge = Convert.ToInt32(Console.ReadLine());
            bool eligible = userAge >= 18 ? true : false;
            string eligibleStatus = Convert.ToString(eligible);
            Console.WriteLine(eligibleStatus);
            Console.ReadLine();
        }
    }
}
