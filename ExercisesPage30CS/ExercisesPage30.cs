...
namespace ExercisesPage30CS
{
    class ExercisesPage30
    {
        static void Main(string[] args)
        {
            ...
            //INSTRUCTOR NOTES (CORRECT IN ORDER TO RECEIVE A PASS): For exercise 1, you should first create the array of strings, then programmatically add the user's text to each string in the array using a for loop--don't just hard code it!
            //I CORRECTED THIS INSTRUCTOR NOTE: For exercise 8, your code won't work unless you change the bool in the do while code block from "correct" to "correct2"
            //INSTRUCTOR NOTES (CORRECT IN ORDER TO RECEIVE A PASS): For exercise 11, like exercise 1, you should not hard code whether the string has already appeared in the list, but should determine so programmatically.
        }
    }
}
